...
public class Poyta {
    ...
    public Scanner luoLukija(String fileNameWithForwardSlash) {
        ...
        try {
            ...
            System.out.println("lukuongelmia @ logiikka.Poyta:luoLukija,\n syötteellä " + fileNameWithForwardSlash + "\n" + e);
        }
    ...
    private void luoOmistukset(Scanner lukija) {
        for (int i = 0; i < 3; i++) {
            ...
            while (omistustenMaara > 0) {
                ...
                omistuspakka.lisaaOmistus(luoOmistus(rivi));
                omistustenMaara--;
            }
        }
     ...
     *
     * @param pelaaja logiikka.Pelaaja, jolle karkki annetaan, jos sellainen löytyy.
     */
